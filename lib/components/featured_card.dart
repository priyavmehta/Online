...
class FeaturedCard extends StatelessWidget {
  ...
  FeaturedCard({@required this.name,@required this.price,@required this.picture,@required this.product,@required this.index});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        onTap: (){
          Navigator.push(context, MaterialPageRoute(builder: (_)=> ProductDetails(product,index)));
        },
        child: Container(
